...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		else if (SONG.song.toLowerCase() == 'pico' || SONG.song.toLowerCase() == 'blammed' || SONG.song.toLowerCase() == 'philly')
		{
			...
			for (i in 0...5)
			{
				var light:FlxSprite = new FlxSprite(city.x, city.y).loadGraphic(Paths.image('philly/win' + i));
			...
			var streetBehind:FlxSprite = new FlxSprite(-25, 50).loadGraphic(Paths.image('philly/behindTrain'));
			add(streetBehind);
		...
		else if (SONG.song.toLowerCase() == 'cocoa' || SONG.song.toLowerCase() == 'eggnog')
		{
			...
			var tree:FlxSprite = new FlxSprite(370, -340).loadGraphic(Paths.image('christmas/christmasTree'));
			tree.antialiasing = true;
			tree.scrollFactor.set(0.40, 0.40);
			add(tree);

			bottomBoppers = new FlxSprite(-300, -55);
		...
		else if (SONG.song.toLowerCase() == 'winter-horrorland')
		{
			...
			var evilTree:FlxSprite = new FlxSprite(700, -300).loadGraphic(Paths.image('christmas/evilTree'));
		...
		else if (SONG.song.toLowerCase() == 'senpai' || SONG.song.toLowerCase() == 'roses')
		{
			...
			bgSky.setGraphicSize(Std.int(bgSky.width * 10));			
			...
			bgTrees.setPosition(bgTrees.x-200, bgTrees.y-200);
			bgSky.setPosition(-300, -200);

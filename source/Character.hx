	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'dad':
				...
				addOffset('idle', 0, 36);
				addOffset("singUP", 0, 126);
				addOffset("singRIGHT", -90, -36);
				addOffset("singLEFT", 80, 36);
			...
			case 'spooky':
				...
				addOffset('danceLeft', -80, 170);
				addOffset('danceRight', -80, 170);

				addOffset("singUP", -80, 190);
				addOffset("singRIGHT", -140, 50);
			...
			case 'pico':
				...
				addOffset('idle', 0, 265);
				addOffset("singUP", 0, 255);
				addOffset("singRIGHT", -55, 265);
				addOffset("singLEFT", 75, 250);
				addOffset("singDOWN", 0, 90);
				addOffset("singUPmiss", 0, 250);
				addOffset("singRIGHTmiss", 0, 250);
				addOffset("singLEFTmiss", 0, 250);
				addOffset("singDOWNmiss", 0, 250);
			...
			case 'bf':
				...
				addOffset('idle', -115, 300);
				addOffset("singUP", -115, 360);
				addOffset("singRIGHT", -10, 300);
				addOffset("singLEFT", 75, 260);
				addOffset("singDOWN", -115, 30);
				addOffset("singUPmiss", -115, 360);
				addOffset("singRIGHTmiss", -10, 300);
				addOffset("singLEFTmiss", 75, 260);
				addOffset("singDOWNmiss", -115, 30);
				addOffset("hey", -105, 300);
				addOffset('firstDeath', -115, -150);
				addOffset('deathLoop', -115, -150);
				addOffset('deathConfirm', -37, -59);
				addOffset('scared', -115, 300);
			...
			case 'parents-christmas':
				...
				addOffset("singRIGHT", 15, -23);
				addOffset("singLEFT", -30, 16);
				addOffset("singDOWN", -31, -29);
				addOffset("singUP-alt", -47, 24);
				addOffset("singRIGHT-alt", 15, -24);

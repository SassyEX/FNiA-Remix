...
class StoryMenuState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var yellowBG:FlxSprite = new FlxSprite(0, 56).makeGraphic(FlxG.width, 400, 0xFFFF6DF2);
		...
		for (char in 0...3)
		{
			...
			{
				case 'dad':
					weekCharacterThing.setGraphicSize(Std.int(weekCharacterThing.width * 0.48));
					weekCharacterThing.updateHitbox();
					weekCharacterThing.y -= 33;
				case 'bf':
					weekCharacterThing.setGraphicSize(Std.int(weekCharacterThing.width * 0.55));
					weekCharacterThing.updateHitbox();
					weekCharacterThing.x += 40;
					weekCharacterThing.y -= 7;
				case 'gf':
	...
	function updateText()
	{
		...
		{
			case 'spooky':
				grpWeekCharacters.members[0].offset.set(145, 183);
				grpWeekCharacters.members[0].setGraphicSize(Std.int(grpWeekCharacters.members[0].width * 1.6));

			case 'pico':
				grpWeekCharacters.members[0].offset.set(115, 170);				
